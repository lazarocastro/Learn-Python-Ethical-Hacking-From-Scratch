...
def get_arguments():
    ...
    parser.add_argument("-t", "--target", dest="target", help="Target IP/IP range. Ex.: 10.0.0.1/24")
...
def scan(ip):
    print(color.GREEN_BOLD + "[+] Scanning Target: " + color.END + ip)
...
def print_result(results_list):
    ...
    if results_list:
        ...
        print(color.RED_BOLD + "[-] Sorry! Target can't be scanning." + color.END)
